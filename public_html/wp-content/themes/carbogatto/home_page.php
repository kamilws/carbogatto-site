...
<section class="main index">
         ...
         <div class="pagination">
            <svg class="__active" data-slide=".top-block">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide=".frame-block">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide=".battery-block">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide=".suspension-block.__front">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide=".suspension-block.__rear">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide=".motor-block">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide=".stand-block">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide=".tyres-block">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide=".create-block">
               <use xlink:href="#svg-hex"></use>
            </svg>
            <svg data-slide="footer.main">
               <use xlink:href="#svg-hex"></use>
            </svg>
         </div>
            ...
            <div class="site-container">
               <div class="container">
                  <div class="video-block">
                     <!--В data-duration выводим продолжительность видео. Выводим чуть меньше на пару десятых секунды, чтобы неуйти дальше чем у видео реально длинна. все уже веведено, троганить ничего не нужно--><!--видео грузятся сразу preload='auto', предполагается, что они будут хорошо сжатыиначе придется что-то другое придумывать--><!--К data-src станет src с расширением webm|mp4 - js это сделает-->
                     <div class="bottom-line"></div>
                     <div class="preloader"></div>
                     <video preload="auto" muted playsinline data-duration="11.7" data-poster="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/top-poster.jpg" data-poster-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/top-poster-mob.jpg" data-src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/top" data-src-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/top-mob.mp4"></video>
                  </div>
                  ...
                  <img class="arrow" src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/arrow-down.png">
               </div>
            </div>
         </div>
               ...
               <div class="container">
                  ...
                  <div class="relative-container">
                     <div class="video-container">
                        ...
                        <video preload="auto" muted playsinline data-duration="4.9" data-poster="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/frame-poster.jpg" data-poster-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/frame-poster-mob.jpg" data-src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/frame" data-src-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/frame-mob.mp4"></video>
                        <div class="bottom-line"></div>
                     </div>
               ...
               <div class="container">
                  ...
                  <div class="relative-container">
                     <div class="video-container">
                        ...
                        <video preload="auto" muted playsinline data-duration="14.95" data-poster="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/battery-poster.jpg" data-poster-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/battery-poster-mob.jpg" data-src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/battery" data-src-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/battery-mob.mp4"></video>
                        <div class="bottom-line"></div>
                     </div>
                     <div class="icons-block lozad __battery">
                        ...
                        <div class="icons-row">
                           ...
                           <div class="icons-title">
                              <!--data-to - до скольки анимируется значение--><span class="__number __capacity" data-to="15">0</span><span>A/h</span>
                           </div>
                           <div class="icons-text">Capacity</div>
                        </div>
                        <div class="icons-line"></div>
                        <div class="icons-row">
                           <!--Вызов +use('voltage') - это тоже самое, что use(xlink:href='#svg-voltage')-->
         ...
         <div class="suspension-block __front vh-slide">
            <div class="site-container">
               <div class="container">
                  <div class="title __absolute"><span>Suspension</span></div>
                  <div class="relative-container">
                     <div class="video-container">
                        <div class="preloader"></div>
                        <div class="top-line"></div>
                        <video preload="auto" muted playsinline data-duration="9.8" data-poster="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-poster.jpg?ver=7" data-poster-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-poster-mob.jpg?ver=7" data-src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus" data-src-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-mob.mp4?ver=7"></video>
                        <div class="bottom-line"></div>
                     </div>
                     <div class="bike lozad __sus-bike">
                        <div class="icon">
                           ...
                           <img class="shocks" src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-bike-front.png">
                        </div>
               ...
               <div class="container">
                  ...
                  <div class="relative-container">
                     <div class="video-container">
                        <div class="preloader"></div>
                        <div class="top-line"></div>
                        <video preload="auto" muted playsinline data-duration="9.5" data-poster="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-rear-poster.jpg" data-poster-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-rear-poster-mob.jpg" data-src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-rear" data-src-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-rear-mob.mp4"></video>
                        <div class="bottom-line"></div>
                     </div>
                     <div class="bike lozad __sus-bike">
                        <div class="icon">
                           ...
                           <img class="shocks" src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/sus-bike-rear.png">
                        </div>
                        <span>Adjustable suspension</span>
                     </div>
                  </div>
               ...
               <div class="container">
                  ...
                  <div class="relative-container">
                     <div class="video-container">
                        <div class="preloader"></div>
                        <div class="top-line"></div>
                        <video preload="auto" muted playsinline data-duration="6.8" data-poster="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/motor-poster.jpg?ver=7" data-poster-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/motor-poster-mob.jpg?ver=7" data-src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/motor" data-src-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/motor-mob.mp4?ver=7"></video>
                        <div class="bottom-line"></div>
                     </div>
               ...
               <div class="container">
                  ...
                  <div class="relative-container">
                     <div class="video-container">
                        <div class="top-line"></div>
                        <div class="preloader"></div>
                        <video preload="auto" muted playsinline data-duration="9.8" data-poster="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/stand-poster.jpg" data-poster-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/stand-poster-mob.jpg" data-src="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/stand" data-src-mob="<?php echo esc_url( get_template_directory_uri() ); ?>/build/img/pages/index/stand-mob.mp4"></video>
                        <div class="bottom-line"></div>
                     </div>
         ...
         <div class="tyres-block vh-slide">
            <div class="site-container">
               <div class="container">
         ...
         <div class="create-block vh-slide __last">
            <div class="site-container">
               <div class="container">
                  ...
                  <p>The City Racer gives you back your city. With its strong performance, CARBO GATTO leaves everything behind them. The slender design provides for true pleasure of driving and even brings a smile to the faces of first-time motorbike riders</p>
                  <div class="text-center"><a class="button" href="<?php echo home_url(); ?>/buy">Config your carbogatto</a></div>
               </div>
            </div>
         </div>
      </section>
