      ...
      <div class="relative-container">
        <div class="video-container">
          ...
          <video preload="auto"
                 ...
                 data-duration="9.5"
                 data-speed="35"
                 data-poster="<?php echo esc_url(get_template_directory_uri()); ?>/build/img/pages/index/sus-rear-poster.jpg"
                 data-poster-mob="<?php echo esc_url(get_template_directory_uri()); ?>/build/img/pages/index/sus-rear-poster-mob.jpg"
                 data-src="<?php echo esc_url(get_template_directory_uri()); ?>/build/img/pages/index/sus-rear.mp4"
                 data-src-mob="<?php echo esc_url(get_template_directory_uri()); ?>/build/img/pages/index/sus-rear-mob.mp4"></video>
        ...
        <div class="bike lozad __sus-bike">
          <div class="icon">
            ...
            <img class="shocks"
                 src="<?php echo esc_url(get_template_directory_uri()); ?>/build/img/pages/index/sus-bike-rear.png">
          </div>
